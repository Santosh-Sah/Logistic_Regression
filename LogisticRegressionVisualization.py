# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 13:55:38 2020
...
from LogisticRegressionUtils import (readLogisticRegressionModel, readLogisticRegressionXTrain, readLogisticRegressionYTrain,
                                         readLogisticRegressionXTest, readLogisticRegressionYTest)
"""
...
def visualisingTrainingSetResult():
    ...
    classifier = readLogisticRegressionModel()
